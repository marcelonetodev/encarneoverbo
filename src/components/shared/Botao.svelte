...
{#if funcao}
  <button
    onclick={funcao}
    class="cursor-pointer text-align text-center justify-center bg-zinc-900 rounded-sm p-2 text-zinc-400 hover:bg-zinc-600 text-sm sm:text-base px-4 sm:px-6"
  >
    {texto}
  </button>
{/if}
